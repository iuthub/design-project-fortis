	...
	<div class="row">
		...
		<div class="col-md-7">
			...
			<div class="row">
				...
				<div class="col-6"><h4><span class="fa fa-space-shuttle"></span> Gym facilities</h4></div>
			</div>
			<div class="row">
				<div class="col-6"> <h4><span class="fa fa-coffee"></span> Breakfast </h4> </div>
				<div class="col-6"><h4><span class="fa fa-tv"></span> TV LCD </h4></div>
			</div>
			<div class="row">
				<div class="col-6"> <h4><span class="fa fa-certificate"></span> Air conditioning</h4> </div>
				<div class="col-6"><h4><span class="fa fa-wifi"></span> Wi-Fi service</h4></div>
			</div>
			<div class="row">
